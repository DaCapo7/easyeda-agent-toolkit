...
> both English and Chinese, distinguished by an `.en.md` / `.zh.md` suffix. The Chinese version of this
> README is in [the second half of this same file](#简体中文). Script docstrings and console output remain
> Chinese.
...
[English](#easyeda-agent-toolkit) | 简体中文
